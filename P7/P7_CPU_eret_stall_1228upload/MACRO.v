...
`define PRId_Addr    5'd15

//EXCEPTION
`define PC_ADDR_START  32'h0000_3000
`define PC_ADDR_END    32'h0000_6fff

`define T0_ADDR_START  32'h0000_7f00
`define T0_ADDR_END    32'h0000_7f0b
`define T1_ADDR_START  32'h0000_7f10
`define T1_ADDR_END    32'h0000_7f1b

`define T0_CTRL_Addr   32'h0000_7f00
`define T0_PRESET_Addr 32'h0000_7f04
`define T0_COUNT_Addr  32'h0000_7f08
`define T1_CTRL_Addr   32'h0000_7f10
`define T1_PRESET_Addr 32'h0000_7f14
`define T1_COUNT_Addr  32'h0000_7f18
