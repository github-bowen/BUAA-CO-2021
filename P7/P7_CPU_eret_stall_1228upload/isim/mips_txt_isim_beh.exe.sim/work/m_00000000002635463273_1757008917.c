...
#endif
static const char *ng0 = "E:/IMPORTANT_FILE/ISE_FOR_PROJECT/P7/P7_CPU_eret_stall_1228upload/E.v";
static unsigned int ng1[] = {0U, 0U};
static int ng2[] = {0, 0};
static unsigned int ng3[] = {16772U, 0U};
static unsigned int ng4[] = {16776U, 0U};
...
LAB103:    xsi_set_current_line(48, ng0);
    t2 = (t0 + 1048U);
    t3 = *((char **)t2);
    t2 = (t0 + 3368);
...
LAB117:    if (*((unsigned int *)t20) > 0)
        goto LAB118;

LAB119:    memcpy(t6, t32, 8);

LAB120:    t26 = (t0 + 4328);
    xsi_vlogvar_wait_assign_value(t26, t6, 0, 0, 5, 0LL);
...
LAB88:    memcpy(t27, t32, 8);

LAB89:    goto LAB71;

LAB72:    xsi_vlog_unsigned_bit_combine(t6, 32, t13, 32, t27, 32);
    goto LAB76;

LAB74:    memcpy(t6, t13, 8);
    goto LAB76;
...
LAB85:    xsi_vlog_unsigned_bit_combine(t27, 32, t31, 32, t32, 32);
    goto LAB89;
...
LAB98:    xsi_vlog_unsigned_bit_combine(t6, 32, t27, 32, t12, 32);
    goto LAB102;

LAB100:    memcpy(t6, t27, 8);
    goto LAB102;
...
LAB116:    xsi_vlog_unsigned_bit_combine(t6, 5, t31, 5, t32, 5);
    goto LAB120;

LAB118:    memcpy(t6, t31, 8);
    goto LAB120;

}


extern void work_m_00000000002635463273_1757008917_init()
{
	static char *pe[] = {(void *)Initial_25_0,(void *)Always_36_1};
	xsi_register_didat("work_m_00000000002635463273_1757008917", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000002635463273_1757008917.didat");
