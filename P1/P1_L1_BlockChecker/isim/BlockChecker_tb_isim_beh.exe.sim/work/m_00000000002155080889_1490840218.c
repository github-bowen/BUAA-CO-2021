...
#endif
static const char *ng0 = "E:/IMPORTANT_FILE/ISE_FOR_PROJECT/P1/P1_L1_BlockChecker/BlockChecker_tb.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {98, 0};
static int ng4[] = {101, 0};
static int ng5[] = {103, 0};
static int ng6[] = {105, 0};
static int ng7[] = {78, 0};
static int ng8[] = {69, 0};
static int ng9[] = {71, 0};
...
{
	static char *pe[] = {(void *)Initial_21_0,(void *)Always_76_1};
